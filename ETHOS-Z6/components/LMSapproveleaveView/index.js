...
function fun_db_APP_Get_Ethos_Leave_Approve(Employee_ID) {
    var datasource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "https://api.everlive.com/v1/demtnkv7hvet83u0/Invoke/SqlProcedures/APP_Get_Ethos_Leave_Approve",
                type: "POST",
                dataType: "json",
                data: {
...
function fun_db_APP_Update_Ethos_Leave_Approval(Ethos_leave_master_id, Remarks, Employee_ID,
    ...
    var datasource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "https://api.everlive.com/v1/demtnkv7hvet83u0/Invoke/SqlProcedures/APP_Update_Ethos_Leave_Approval",
                type: "POST",
                dataType: "json",
                data: {
...
function fun_db_APP_Update_Ethos_Leave_Rejected(Ethos_leave_master_id, Remarks, isrejected,
    ...
    var datasource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "https://api.everlive.com/v1/demtnkv7hvet83u0/Invoke/SqlProcedures/APP_Update_Ethos_Leave_Rejected",
                type: "POST",
                dataType: "json",
                data: {
