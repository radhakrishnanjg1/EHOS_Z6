        ...
        change: function (e) {
            ...
            if (value.length > 6) {
               ...
               .ToJSON());
                ...
                $('#dvteamename').html(value.split("|")[0]);
                app.utils.loading(true);
                fun_db_APP_Get_MSL_Coverage_Details_Z6_Employee_TeamByEmployeeid(empid);
            }
            else if (value == 'ALL') {
                $('#dvteamename').html('Team');
                app.utils.loading(true);
...
function fun_db_APP_Get_MSL_Coverage_Details_Z6_Employee_Team(Employee_ID) {
    var datasource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "https://api.everlive.com/v1/demtnkv7hvet83u0/Invoke/SqlProcedures/APP_Get_MSL_Coverage_Details_Z6_Employee_Team",
                type: "POST",
                dataType: "json",
                data: {
...
function fun_db_APP_Get_Current_MSL_Coverage_Details_Z6_Employee_Team(Employee_ID) {
    var datasource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "https://api.everlive.com/v1/demtnkv7hvet83u0/Invoke/SqlProcedures/APP_Get_Current_MSL_Coverage_Details_Z6_Employee_Team",
                type: "POST",
                dataType: "json",
                data: {
                    "Employee_ID": Employee_ID
...
function fun_db_APP_Get_MSL_Coverage_Details_Z6_Employee_TeamByEmployeeid(Employee_ID) {
    var datasource = new kendo.data.DataSource({
        transport: {
            read: {
...
function fun_db_APP_Get_Current_MSL_Coverage_Details_Z6_Employee_TeamByEmployeeid(Employee_ID) {
    var datasource = new kendo.data.DataSource({
        transport: {
            read: {
