...
function fun_db_APP_Get_Ethos_Leave_Cancel(Employee_ID) {
    var datasource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "https://api.everlive.com/v1/demtnkv7hvet83u0/Invoke/SqlProcedures/App_Get_Ethos_Leave_Cancel",
                type: "POST",
                dataType: "json",
                data: {
...
function fun_db_APP_Update_Ethos_Leave_Cancel(Ethos_leave_master_id, Reason_For_Cancel, cancelled_by) {
    var datasource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "https://api.everlive.com/v1/demtnkv7hvet83u0/Invoke/SqlProcedures/APP_Update_Ethos_Leave_Cancel",
                type: "POST",
                dataType: "json",
                data: {
