...
function fun_db_APP_Get_Employee_Leave_Details(leavetype, Employee_ID) {
    var datasource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "https://api.everlive.com/v1/demtnkv7hvet83u0/Invoke/SqlProcedures/APP_Get_Employee_Leave_Details",
                type: "POST",
                dataType: "json",
                data: {
...
function fun_db_APP_Insert_Ethos_Leave_Master(Employee_ID, Leave_Type_ID, Opening_Bal,
    ...
    var datasource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "https://api.everlive.com/v1/demtnkv7hvet83u0/Invoke/SqlProcedures/APP_Insert_Ethos_Leave_Master",
                type: "POST",
                dataType: "json",
                data: {
